...
<head>
		...
		<meta name="keywords" content="사무Office,주현컴퓨터학원,">
		<meta name="description" content="사무Office - 주현컴퓨터학원">
		<title>사무Office - 주현컴퓨터학원</title>
		<!-- <link rel="stylesheet" type="text/css" href="./css/google_webfont.css" /> -->
		<link rel="stylesheet" type="text/css" href="./css/common.css?uniq=1464938316">
		<link rel="stylesheet" type="text/css" href="./css/pc.css?uniq=1464938316">
		<link rel="stylesheet" type="text/css" href="./css/member.css?uniq=1464938316">
		<link rel="stylesheet" type="text/css" href="./css/board.css?uniq=1464938316">
		<link rel="stylesheet" type="text/css" href="./css/form.css?uniq=1464938316">
		<link rel="stylesheet" type="text/css" href="./css/diary.css?uniq=1464938316">
		<link rel="stylesheet" type="text/css" href="./SmartEditor2/css/smart_editor2_out.css?uniq=1464938316">
		...
		<script type="text/javascript" src="./js/js.js?uniq=1464938316"></script>
		<script type="text/javascript">
			//<![CDATA[
...
<body>
	<div id="visual_area" style="height:150px;">									<div id="visual_group_0" class="visual_group" style="height:150px; z-index:12;">
										<div class="visual_left">
											<div class="visual_left_in" style="background:#EEEEEE"></div>
										</div>
										<div class="visual_right">
											<div class="visual_right_in" style="background:#EEEEEE"></div>
										</div>
										<div class="visual_center">
											<img src="./img/20151016114427-a8f77db383.png" alt="">										</div>
									</div>
						</div>
						<div id="content_area">
...
<div class="title_n_loc">
	<span class="loc">
		<a href="./main.php"><span class="loc1">홈</span></a>
					<a href="./main.php?m1=3" target="_self"><span class="loc2">재직자훈련</span></a>
			<span class="loc3">사무Office</span>
					</span>
	<h2><span class="title">사무Office</span></h2>
</div>
...
<div id="dp_board_pc_list_top_total_record">
	전체 : <span>1</span>
	</div><div id="dp_board_pc_list_B_type">
	
	

	<ul>	
					<li class="first_line">
																			<span class="no"><span class="hidden">글번호:</span>1</span>
																								<div class="title_content" style="width:910px;">
							<a href="/main.php?m1=3&amp;m2=8&amp;m3=&amp;board_mode=list&amp;board_no=&amp;board_search_keyword=&amp;board_page=1&amp;board_search_head_word=&amp;board_mode=view&amp;board_no=31">																<span class="hidden">제목:</span><span class="title">기본 오피스과정</span>
							...
							<span class="hidden">글 내용 일부:</span><p class="content"><a href="/main.php?m1=3&amp;m2=8&amp;m3=&amp;board_mode=list&amp;board_no=&amp;board_search_keyword=&amp;board_page=1&amp;board_search_head_word=&amp;board_mode=view&amp;board_no=31">사무office1. win 기본과정2. 아래한글 기본과정3. 인터넷 기본과정4. 엑셀 기본과정5. 파워포인트 기본과정</a></p>						</div>
					</li>
	</ul></div>
